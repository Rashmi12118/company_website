		...
		<div class="row">
			<div class="col-sm-9">
				...
				<div class="row">
					...
					<div class="col-sm-12">
						<h4>Overview</h4>
						<p>This para contains general information about IMS</p>
					</div>
				</div>
								...
								<div class="panel-group" id="accordion">
										...
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion"
													href="#collapseOne"> <i class="fa fa-desktop"></i> <b>Enterprise systems management</b>
												</a>
											</h4>
										</div>
										<div id="collapseOne" class="panel-collapse collapse">
											<div class="panel-body">
												Organizations that are still depending on legacy mainframe applications,finds difficulty in responding to quickly changing business requirements
 												ESM is developed as a result of the widespread migration from centralised mainframe and/or midrange computers to smaller distributed computers. 
 												ESM aims to solve major hardships associated with such migrations to achieve Reliability, Availability and Serviceability while significantly reducing IT spend.
												
												<div class="divide10"></div>
												
												Our ESM Methodology comprises of :
												...
												<div class="divide10"></div>
													...
													<span>
													   <span class="fa fa-sign-out"></span>
													   <span>Middleware management</span>
													</span>  
													 <br>
									                 <span>
													   <span class="fa fa-sign-out"></span>
													   <span>Cloud operations management</span>
													</span> 
													<br>
													 <span>
													   <span class="fa fa-sign-out"></span>
													...
													<br> 
													 <span>
													   <span class="fa fa-sign-out"></span>
													   <span>User's activities monitoring</span>
													</span> 
													<br> 
													 <span>
													   <span class="fa fa-sign-out"></span>
                                                    ...
                                                    <span>
													   <span class="fa fa-sign-out"></span>
													   <span>Network capacity and utilization monitoring</span>
													</span> 
													<br> 
													<span>
													   <span class="fa fa-sign-out"></span>
									...
									<div class="panel panel-default" id="panel2">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion"
													href="#collapseTwo"> <i class="fa fa-desktop"></i> <b>Network management </b>
												</a>
											</h4>
										</div>
										<div id="collapseTwo" class="panel-collapse collapse">
											<div class="panel-body">
												Earlier computer networks were elementary and simple, consisting mainly of one or more mainframes connected to a few peripherals. 
												Since the number of network resources was lesser, managing such networks was relatively simple.
												But as networks grow, they also become more complex to manage.
									<div class="divide10"></div>		
												It’s important that you have an integrated network management system that makes the task of running a large-scale operation simpler without causing you added overhead with reduced 
									...
									<div class="panel panel-default" id="panel3">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion"
													href="#collapseThree"> <i class="fa fa-desktop"></i> <b>Helpdesk and Desktop Services </b>
												</a>
											</h4>
										</div>
										<div id="collapseThree" class="panel-collapse collapse">
											<div class="panel-body">
												...
												HDS can help companies resolve tech issues faster and allow IT departments to work more efficiently. 
												How? Simply put, a help desk organizes information, streamlines workflows, and eliminates many manual processes. 
												With help desk software (often a subset of a service desk software), no longer will an IT support specialist have to laboriously log issues by hand, 
												dig through disorganized emails to get to the bottom of a problem, track the status of issues manually, or 
												let requests slip through the cracks.
												<div class="divide10"></div>
												
											<div class="divide10"></div>
											Our Helpdesk and Desktop Methodology comprises of :
											<div class="divide10"></div> 	
												    <span>
													   <span class="fa fa-sign-out"></span>
													   <span>Single point of contact (SPOC) for IT interruptions</span>
													</span>  
													<br>
													<span>
													   <span class="fa fa-sign-out"></span>
													   <span> Computer or Software consultations</span>
													</span>  
													<br>
													<span>
													   <span class="fa fa-sign-out"></span>
													   <span>Tracking capabilities of all incoming problems</span>
													</span>  
													 <br>
									                 <span>
													   <span class="fa fa-sign-out"></span>
													...
													<br>
													 <span>
													   <span class="fa fa-sign-out"></span>
													   <span>24*7 Customer Interface</span>
													</span> 

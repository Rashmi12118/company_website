			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown yamm-fw"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown">Our Product</a></li>
		...
		<div class="row">
			<div class="col-sm-9">
				...
				<div class="row"><!--  Start of Mobility Overview  -->
					<div class="col-sm-12">
						<h4>Overview</h4>
						<p>This will contain an overview of Product Developement  Solutions..</p>
					</div>
...
<!-- 								<ul class="list-group"> -->
<!-- 								    <li> NMBR offer a complete spectrum of services — our -->
<!-- 									enterprise mobility services cover all your mobility needs from -->
<!-- 									strategic planning to device management to end-user -->
<!-- 									applications and network infrastructure.</li> -->
								
<!-- 									<li class="list-group-item "> -->
<!-- 									   <span class="fa fa-sign-out"></span> -->
<!-- 									   <span>Defining the enterprise mobile strategy - identifying applications and systems that can be mobile enabled, the scope of mobilizing them and the business benefits that can be obtained.</span></li> -->
<!-- 									<li class="list-group-item"><span class="fa fa-sign-out"></span> -->
<!-- 										<span>Defining the mobile devices strategy - defining the platform of choice for the enterprise mobility clients</span></li> -->
								
<!-- 									<li class="list-group-item"> -->
<!-- 									<span class="fa fa-sign-out"></span> -->
<!-- 									<span>Complete mobile application development with seamless integration to backend systems</span></li> -->
<!-- 									<li class="list-group-item"> -->
<!-- 									<span class="fa fa-sign-out"></span> -->
<!-- 									<span>>Designing or Modifying existing solution for better performance optimization</span></li> -->
...
<!-- 									<li class="list-group-item "> -->
<!-- 									   <span class="fa fa-sign-out"></span> -->
<!-- 										<span>Experienced Designing & Developing Android , iOS and Non Native Mobile applications</span></li> -->
<!-- 									<li class="list-group-item"><span class="fa fa-sign-out"></span> -->
<!-- 										<span>Strong OO design and programming skills in Java</span></li> -->
<!-- 									<li class="list-group-item"> -->
<!-- 									   <span class="fa fa-sign-out"></span> -->
<!-- 										<span>Strong knowledge of mobile database management system like SQLite</span></li> -->
<!-- 									<li class="list-group-item"> -->
<!-- 									<span class="fa fa-sign-out"></span> -->
<!-- 									<span>Experience on web service integration (SOAP, REST, JSON, XML)</span></li> -->
				...
				<div class="divide30"></div>
				   ...
				   <div class="row"><!--  Start of Mobility Stack  -->
					<div class="col-sm-12">
					    ...
					    <p>NMBR has the following Product development competency technology stack:</p>
					</div>
					</div>
				
<!-- 				    <div class="row"> -->
<!-- 	                    <div class="col-md-2 col-sm-6 margin20"> -->
<%-- 	                     <img   alt="darkblurbg" src="<c:url value="/resources/img/slide2/android.png"/>"/> --%>
<!-- 	                    </div> -->
                    
<!-- 	                     <div class="col-md-2 col-sm-6 margin20"> -->
<%-- 	                        <img  alt="darkblurbg"  src="<c:url value="/resources/img/slide2/apple.png"/>"/> --%>
<!-- 	                     </div> -->
	                     
<!-- 	                      <div class="col-md-2 col-sm-6 margin20"> -->
<!-- 	                      <div class="divide10"></div> -->
<%-- 	                        <img  alt="darkblurbg"  src="<c:url value="/resources/img/slide2/phonegap.png"/>"/> --%>
<!-- 	                     </div> -->
	                     
<!-- 	                      <div class="col-md-2 col-sm-6 margin20"> -->
<!-- 	                      <div class="divide30"></div> -->
<%-- 	                        <img  alt="darkblurbg"  src="<c:url value="/resources/img/slide2/cordova.png"/>"/> --%>
<!-- 	                     </div> -->
	                     
<!-- 	                      <div class="col-md-2 col-sm-6 margin20"> -->
<!-- 	                      <div class="divide10"></div> -->
<%-- 	                        <img  alt="darkblurbg"  src="<c:url value="/resources/img/slide2/ionic.png"/>"/> --%>
<!-- 	                     </div> -->
